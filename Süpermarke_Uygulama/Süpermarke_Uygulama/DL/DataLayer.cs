...
namespace Süpermarke_Uygulama.DL
{
    public static class DataLayer
    {
        ...
        public static int MüşteriEkle(Musteri m)
        {
            try
            {
                if (conn.State != System.Data.ConnectionState.Open)
                    conn.Open();
                MySqlCommand komut =new MySqlCommand("supermarket_MusteriEkle", conn);
        ...
        internal static int SatisEkle(Satis s)
        {
            try
            {
                if (conn.State != System.Data.ConnectionState.Open)
                    conn.Open();
                MySqlCommand komut = new MySqlCommand("supermarket_SatisEkle", conn);
                komut.CommandType = System.Data.CommandType.StoredProcedure;
        ...
        internal static DataSet SatisGetir()
        {
            try
            {
                ...
                MySqlCommand  komut = new MySqlCommand("supermarket_SatisDetay", conn);
                    komut.CommandType = System.Data.CommandType.StoredProcedure;
        ...
        internal static int MüşteriSil(object id)
        {
            try
            {
                if (conn.State != System.Data.ConnectionState.Open)
                    conn.Open();
                MySqlCommand komut = new MySqlCommand("supermarket_MusteriSil", conn);
                komut.CommandType = System.Data.CommandType.StoredProcedure;
        ...
        internal static DataSet UrunGetir(string filtre)
        {
            try
            {
                ...
                {
                    komut = new MySqlCommand("supermarket_UrunlerHepsi", conn);
                    komut.CommandType = System.Data.CommandType.StoredProcedure;
                }
                else
                {
                    komut = new MySqlCommand("supermarket_UrunBul", conn);
                    komut.CommandType = System.Data.CommandType.StoredProcedure;
        ...
        internal static int UrunEkle(Urun u)
        {
            try
            {
                if (conn.State != System.Data.ConnectionState.Open)
                    conn.Open();
                MySqlCommand komut = new MySqlCommand("supermarket_UrunEkle", conn);
                komut.CommandType = System.Data.CommandType.StoredProcedure;
        ...
        internal static int MüşteriGüncelle(Musteri m)
        {
            try
            {
                if (conn.State != System.Data.ConnectionState.Open)
                    conn.Open();
                MySqlCommand komut = new MySqlCommand("supermarket_MusteriGuncelle", conn);
                komut.CommandType = System.Data.CommandType.StoredProcedure;
                komut.Parameters.AddWithValue("@id", m.ID);
                komut.Parameters.AddWithValue("@ad", m.Ad);
                komut.Parameters.AddWithValue("@soy", m.Soyad);
        ...
        internal static DataSet MüşteriGetir(string filtre)
        {
            try
            {
                ...
                if (string.IsNullOrEmpty(filtre))
                {
                    komut = new MySqlCommand("supermarket_MusterilerHepsi", conn);
                    komut.CommandType = System.Data.CommandType.StoredProcedure;
                }
                else
                {
                    komut = new MySqlCommand("supermarket_MusteriBul", conn);
                    komut.CommandType = System.Data.CommandType.StoredProcedure;
                    komut.Parameters.AddWithValue("@filtre", filtre);
